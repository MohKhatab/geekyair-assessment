...
export default function CaseStudySection() {
  return (
    <Section className="grid grid-cols-2 gap-16 bg-[#EEECFF]">
      <div>
      ...
      <div className="flex flex-col gap-12">
        ...
        <Button
          size="hero"
          className="px-12 uppercase w-fit"
          variant="secondary"
        >
          Read Case study
        </Button>
        ...
        <Tabs defaultValue="1">
          <TabsList className="bg-transparent">
            <TabsTrigger
              ...
              data-[state=active]:border-[#009387] rounded-none data-[state=active]:bg-transparent px-6 pb-8 cursor-pointer
